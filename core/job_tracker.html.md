...
>  TranscriptionJob (id:str, plugin_name:str, file_path:str, file_name:str,
>                        status:str='pending', created_at:str=<factory>,
...
>  TranscriptionJobTracker (on_job_completed:Optional[Callable[[str,ForwardR
>                               ef('TranscriptionJobTracker')],NoneType]]=None)
